...
void main(void)
{
  ...
  hires_putc(17,96,ROP_CPY,';');
  hires_putc(18,96,ROP_CPY,'@');
  hires_putc(19,96,ROP_CPY,'@');
  hires_putc(20,96,ROP_CPY,'@');
  hires_putc(21,96,ROP_CPY,'@');
  hires_putc(22,96,ROP_CPY,'<');
  hires_putc(17,104,ROP_CPY,'?');
  hires_putc(22,104,ROP_CPY,'?');
  hires_putc(17,112,ROP_CPY,'=');
  hires_putc(18,112,ROP_CPY,'@');
  hires_putc(19,112,ROP_CPY,'@');
  hires_putc(20,112,ROP_CPY,'@');
  hires_putc(21,112,ROP_CPY,'@');
  hires_putc(22,112,ROP_CPY,'>');
