...
def replace_mag_with_c_char(mag_contents_in, c_start_replacement, mag_contents_in, c_mag_start_collection, binary_output=False):
...
if __name__ == "__main__":
    ...
    print("Merging...")
    binary_output = False
    mag_contents = replace_mag_with_c_char(mag_contents, "* CHAR DEFS", c_contents, "//  space character", binary_output)

    mag_contents = replace_mag_with_c_colour(mag_contents"* COLORSET",  c_contents, "//  space color")

    write_file(mag_file_out, c_contents)
